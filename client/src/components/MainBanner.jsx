...
function MainBanner() {
    return (
        ...
        <div className=' relative'>
            ...
            />
            <img
                className='w-full  md:hidden h-[75vh]'
            ...
            <div className='absolute inset-0 flex flex-col items-center md:items-start justify-end md:justify-center pb-24 md:pb-0 px-4 md:pl-18     lg:pl-24'>
                ...
                <div className='flex items-center mt-6 font-medium'>
                    <Link to='/products' className='group flex items-center gap-2 px-7 md:px-9 py-3 text-white transition rounded bg-green-500 hover:bg-green-700  cursor-pointer' >
                        Shop now
